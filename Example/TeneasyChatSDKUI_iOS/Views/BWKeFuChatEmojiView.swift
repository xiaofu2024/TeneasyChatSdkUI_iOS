...
//        emoImageView.setImage(UIImage.svgInit("lt_biaoqing"), for: .normal)
        ...
        //删除按钮
        deleteBtn = WButton()
//        deleteBtn.setImage(UIImage.svgInit("xtbq_guanbi1"), for: .normal)
//        deleteBtn.setImage(UIImage.svgInit("xtbq_guanbi2"), for: .disabled)
        ...
        addSubview(clcView)
//        let allEmotionLabel = UILabel(font: 13, color: .black, alignment: .left)
